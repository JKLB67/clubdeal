    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-60 bg-white border-r border-gray-200 flex flex-col fixed inset-y-0">
        ...
        <div className="px-3 py-4 border-t border-gray-100 space-y-1">
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2.5 w-full rounded-lg text-sm text-gray-500 hover:text-blue-700 hover:bg-blue-50 transition-colors"
          >
            <ArrowLeft className="w-4 h-4" />
            Retour au dashboard
          </Link>
          <p className="text-xs text-gray-400 px-3 pt-1 truncate">{user.email}</p>
          <button
